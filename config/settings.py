...
# Email configuration (defaults to console backend for local dev and testing)
...
CELERY_BEAT_SCHEDULE = {
    'send-overdue-tasks-digest-daily': {
        'task': 'apps.tasks.tasks.send_overdue_tasks_digest',
        'schedule': 86400.0,
    },
}
